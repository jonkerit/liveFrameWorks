//
//  BJLScWindowViewController+protected.h
//  BJLiveUI
//
...
FOUNDATION_EXPORT const CGPoint BJLSPointNull;
...
@property (nonatomic, readonly) BJLScWindowTopBar *topBar;
@property (nonatomic, readonly) BJLScWindowBottomBar *bottomBar;

@property (nonatomic) NSMutableArray<UIGestureRecognizer *> *windowGestures;

@end

@interface BJLScWindowViewController (protected)

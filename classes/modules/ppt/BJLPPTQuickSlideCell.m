...
- (void)setUpContentView {
    ...
    self.deleteButton = ({
        ...
        [button setImage:[UIImage bjl_imageNamed:@"bjl_ic_ppt_delete"] forState:UIControlStateNormal];
...
- (void)setSelected:(BOOL)selected {
    ...
    self.pptView.layer.borderWidth = selected ? 2.0 : BJLOnePixel;
    self.pptView.layer.borderColor = selected ? [[UIColor bjl_blueBrandColor] CGColor] : [[UIColor bjl_grayLineColor] CGColor];
}

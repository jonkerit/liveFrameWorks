...
@property (nonatomic) BOOL tapBackgroundToHide; // 默认 YES
@property (nonatomic) UIColor *backgroundColor; // 默认 [UIColor bjl_dimColor]
...
/**
 ...
 !!!: 这里 hor/ver 是指 size.width > size.height，而不是 BJLIsHorizontalUI(self)
 
 #param remakeConstraintsBlock  用于设置布局
 !!!: remakeConstraintsBlock 里
 isHorizontalUI = BJLIsHorizontalUI(self)
 isHorizontalSize = size.width > size.height
 */
